...
public class Newspaper extends Item 
{
    ...
    public Newspaper(String itemId) //Constructor given just item ID
    {
    ...
    public Newspaper (String itemId, String checkedOutTo) //Constructor given all member fields
    {
       // super(itemId, checkedOutTo); //Takes the constructor from the super
